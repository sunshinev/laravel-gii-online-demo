    ...
    module.exports = {
        data: function() {
            return {
                ...
                col_list: [
                    ...
                    {title:'email_verified_at', key:'email_verified_at'},
                    {title:'password', key:'password'},
                    {title:'remember_token', key:'remember_token'},
        ...
        methods: {
            tableData: function() {
                ...
                this.axios
                    .post('/api/admin/users/list'+pageStr,JSON.stringify(search_list))
                    .then(response=>{
            ...
            invokeConfirmDelete: function(row) {
                this.axios
                    .post('/api/admin/users/delete',JSON.stringify({'id':row.id}))
                    .then(response=>{
            ...
            invokeConfirmBatchDelete: function() {
                this.axios
                    .post('/api/admin/users/batch_delete',JSON.stringify({'ids':this.batchDeleteModalData}))
                    .then(response=>{
